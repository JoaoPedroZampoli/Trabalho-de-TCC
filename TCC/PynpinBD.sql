...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 04-Dez-2022 às 02:47
...
CREATE TABLE IF NOT EXISTS `tb_categorias` (
  ...
  `ImagemCategoria` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_cores` (
  ...
  `NomeCor` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `CodigoCor` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_produtos` (
  ...
  `Imagem2Produto` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Imagem3Produto` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Imagem4Produto` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `tb_produtos` (`IdProduto`, `NomeProduto`, `DescricaoProduto`, `PrecoProduto`, `Imagem1Produto`, `Imagem2Produto`, `Imagem3Produto`, `Imagem4Produto`, `TextoAlternativoProduto`, `PromoInfoProduto`, `PromoBackgroundProduto`, `DataCriacaoProduto`, `DataUltimaAlteracaoProduto`) VALUES
...
CREATE TABLE IF NOT EXISTS `tb_tamanhos` (
  ...
  `NomeTamanho` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
